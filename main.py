#Input 1(img)+Input 2(caption_sequence)->Output(Next word)
import string
import numpy as np
...
# For seeing the progress of loops.
...
vocab_size= len(tokenizer.word_index) + 1 #index 0 used for-Padding
print(vocab_size)
